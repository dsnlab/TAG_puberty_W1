...
packages = c("ggplot2", "tidyr", "dplyr", "knitr", "rio", "stringr")
...
saliva_mean_df$SID <- str_pad(saliva_mean_df$SID, 3, pad = "0")
saliva_mean_df$SID <- paste0("TAG", saliva_mean_df$SID)
...
pss_df <- pss_df[order(pss_df$SID), ] # order by subject ID
pss_df <- unique(pss_df)# remove duplicated rows
