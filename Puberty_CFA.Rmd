...
anova(fit_model_sr1_pml_nocov, fit_model_sr2_pml_nocov)
fitmeasures(fit_model_sr1_pml_nocov,
            fit.measures = c("cfi","ecvi","mfi", "chisq", "pvalue", "rmsea"))
fitmeasures(fit_model_sr2_pml_nocov,
            fit.measures = c("cfi","ecvi","mfi", "chisq", "pvalue", "rmsea"))
...
#Self-Report
pub_sr =~ PDS2 + PDS3 + PDS4 + PDS6 + PBIP1 + PBIP2
...
#Self-Report Puberty
sr_puberty =~ PDS2 + PDS3 + PDS4 + PDS6 + PBIP1 + PBIP2
