...
fitmea_slm4_pml <- fitMeasures(fit_slm4_pml, fit.measures = c("cfi","ecvi","mfi", "chisq", "pvalue", "rmsea"))
...
fitmea_hm <- data.frame(fitmea_hm1v2_pml, fitmea_hm2v2_pml, fitmea_hm3v2_pml,
                         fitmea_hm4v2_pml)
fitmea_slm <- data.frame(fitmea_slm1_pml, fitmea_slm2_pml, fitmea_slm3_pml,
                          fitmea_slm4_pml)
fitmea_hsm <- data.frame(fitmea_hsm1_pml, fitmea_hsm2_pml)
fitmea_fm <- data.frame(fitmea_fm1_pml, fitmea_fm2_pml, fitmea_fm3_pml,
                        fitmea_fm4_pml)
#fitmea_sem <- data.frame(fitmea_sem1_pml, fitmea_sem2_pml, fitmea_sem3_pml, fitmea_sem4_pml)
