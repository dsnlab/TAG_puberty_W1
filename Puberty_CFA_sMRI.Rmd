...
# Fit SLM3
fit_slm4_mlr <- cfa(slm4, data = data, missing = "ML", estimator = "MLR", se = "robust.mlr")

# Summary Stats for SLM3
summary(fit_slm4_mlr, fit.measures = T, standardized = T)
...
pub_scores <- pub_scores %>% full_join(sMRI)
...
# We start with the ones that popped up in the extracted correlations above:
# left inferior parietal (l_infpar / lh_inferiorparietal_thickness), right inferior parietal (r_infpar), 
# left precuneus (l_prec), right cuneus (r_cun), right superior temporal sulcus 
# (r_sts), right occipital (r_occ), right paracentral (r_paracen)
...
l_infpar_fac =~ lh_inferiorparietal_thickness
"
...
"
# Fit models
fit_fm2v2_l_infpar_cor <- cfa(fm2v2_l_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     ) 

fit_fm1v2_l_infpar_cor <- cfa(fm1v2_l_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )

fit_sr1_l_infpar_cor <- cfa(sr1_l_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )

fit_sr2_l_infpar_cor <- cfa(sr2_l_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )
fit_hm1_l_infpar_cor <- cfa(hm1_l_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )

fit_hm2_l_infpar_cor <- cfa(hm2_l_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )


# Summary Stats for models
summary(fit_fm2v2_l_infpar_cor, fit.measures = T, standardized = T)
fitmea_fm2v2_l_infpar_cor <- fitmeasures(fit_fm2v2_l_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_fm1v2_l_infpar_cor, fit.measures = T, standardized = T)
fitmea_fm1v2_l_infpar_cor <- fitmeasures(fit_fm1v2_l_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_sr1_l_infpar_cor, fit.measures = T, standardized = T)
fitmea_sr1_l_infpar_cor <- fitmeasures(fit_sr1_l_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_sr2_l_infpar_cor, fit.measures = T, standardized = T)
fitmea_sr2_l_infpar_cor <- fitmeasures(fit_sr2_l_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_hm1_l_infpar_cor, fit.measures = T, standardized = T)
fitmea_hm1_l_infpar_cor <- fitmeasures(fit_hm1_l_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_hm2_l_infpar_cor, fit.measures = T, standardized = T)
fitmea_hm2_l_infpar_cor <- fitmeasures(fit_hm2_l_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

fit_fm2v2_l_infpar_cor_parest <- parameterEstimates(fit_fm2v2_l_infpar_cor)
lavaan:::ctr_pml_plrt(fit_fm2v2_l_infpar_cor)

# Pictoral Representation of FM2v2_l_infpar_cor
semPaths(fit_fm2v2_l_infpar_cor)
...
#covary observed l_infpar and latent neuroendo systems by tricking lavaan 
# (remember that lavaan always fixes the first loading to 1)
r_infpar_fac =~ rh_inferiorparietal_thickness
"
...
"
# Fit models
fit_fm2v2_r_infpar_cor <- cfa(fm2v2_r_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     ) 

fit_fm1v2_r_infpar_cor <- cfa(fm1v2_r_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )

fit_sr1_r_infpar_cor <- cfa(sr1_r_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )

fit_sr2_r_infpar_cor <- cfa(sr2_r_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )
fit_hm1_r_infpar_cor <- cfa(hm1_r_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )

fit_hm2_r_infpar_cor <- cfa(hm2_r_infpar_cor, data = data, estimator = "ML", 
                      missing = "available.cases", verbose = T,  
                     )


# Summary Stats for models
summary(fit_fm2v2_r_infpar_cor, fit.measures = T, standardized = T)
fitmea_fm2v2_r_infpar_cor <- fitmeasures(fit_fm2v2_r_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_fm1v2_r_infpar_cor, fit.measures = T, standardized = T)
fitmea_fm1v2_r_infpar_cor <- fitmeasures(fit_fm1v2_r_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_sr1_r_infpar_cor, fit.measures = T, standardized = T)
fitmea_sr1_r_infpar_cor <- fitmeasures(fit_sr1_r_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_sr2_r_infpar_cor, fit.measures = T, standardized = T)
fitmea_sr2_r_infpar_cor <- fitmeasures(fit_sr2_r_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_hm1_r_infpar_cor, fit.measures = T, standardized = T)
fitmea_hm1_r_infpar_cor <- fitmeasures(fit_hm1_r_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))

summary(fit_hm2_r_infpar_cor, fit.measures = T, standardized = T)
fitmea_hm2_r_infpar_cor <- fitmeasures(fit_hm2_r_infpar_cor, fit.measures = c("cfi","ecvi","mfi"))


fit_fm2v2_r_infpar_cor_parest <- parameterEstimates(fit_fm2v2_r_infpar_cor)
lavaan:::ctr_pml_plrt(fit_fm2v2_r_infpar_cor)

# Pictoral Representation of FM2v2_l_infpar_cor
semPaths(fit_fm2v2_r_infpar_cor)
